...
?>
	...
	<div class="container" style="margin-top:20px">
		...
		<hr>
		<a href="main.php?page=tambah_mhs"><button class="btn btn-dark right">Tambah Data</button></a>
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>
								<a href="main.php?page=edit_mhs&Nim='.$data['Nim'].'" class="btn btn-secondary btn-sm">Edit</a>
