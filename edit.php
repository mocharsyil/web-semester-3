<?php include('config.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="main.php?page=tampil_mhs";</script>';
			}else{
		...
		<form action="main.php?page=edit_mhs&Nim=<?php echo $Nim; ?>" method="post">
			...
			<div class="item form-group">
				<div class="col-md-6 col-sm-6 offset-md-3">
					...
					<a href="main.php?page=tampil_mhs" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
